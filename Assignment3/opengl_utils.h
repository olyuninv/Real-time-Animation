...
namespace Assignment3
{
	...
	public:
		...
		void createShaders()
		{
			...
			PhongProgramID = LoadShaders("../Assignment3/shaders/blinnPhong.vs", "../Assignment3/shaders/blinnPhong.fs");	
			SimpleShaderID = LoadShaders("../Assignment3/shaders/simpleShader.vs", "../Assignment3/shaders/simpleShader.fs");
			CubeMapID = LoadShaders("../Assignment3/shaders/cubeMap.vs", "../Assignment3/shaders/cubeMap.fs");
		}
