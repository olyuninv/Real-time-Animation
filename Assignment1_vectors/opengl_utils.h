...
namespace Assignment1_vectors
{
	...
	public:
		...
		void createShaders()
		{
			...
			PhongProgramID = LoadShaders("../Assignment1_vectors/shaders/phong.vs", "../Assignment1_vectors/shaders/phong.fs");	
			//SimpleShaderID = LoadShaders("../Assignment1_vectors/shaders/simpleShader.vs", "../Assignment1_vectors/shaders/circle.fs");
		}
		...
		void linkFaceBuffertoShader(int faceVAO_positions)
		{
			...
			glVertexAttribPointer(loc3, 2, GL_FLOAT, GL_FALSE, 0, (void*)0);
