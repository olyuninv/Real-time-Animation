...
namespace Assignment2
{
	...
	public:
		...
		void createShaders()
		{
			...
			PhongProgramID = LoadShaders("../Assignment2_imgui_example/shaders/blinnPhong.vs", "../Assignment2/shaders/blinnPhong.fs");	
			SimpleShaderID = LoadShaders("../Assignment2_imgui_example/shaders/simpleShader.vs", "../Assignment2/shaders/simpleShader.fs");
		}
