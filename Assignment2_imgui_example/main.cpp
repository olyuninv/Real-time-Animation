...
void createObjects()
{
	...
	const char* cubeFileName = "../Assignment2_imgui_example/meshes/small_airplane/planeUV.obj";
...
int main(int, char**)
{
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Geometrical Transformations", NULL, NULL);
    if (window == NULL)
        return 1;
